 ...
 *  Address spaces
 */
/* let's try C, not F, to make lguest happier? */
...
/* HACK */
#undef CPU0MACH
#define	CPU0MACH	(KZERO+0x15000)		/* Mach for bootstrap processor */
...
#define	KDSEG	13	/* kernel data/stack */
#define	KESEG	12	/* kernel executable */	
#define	UDSEG	15	/* user data/stack */
#define	UESEG	14	/* user executable */
#define	TSSSEG	16	/* task segment */
...
#define	KDSEL	SELECTOR(KDSEG, SELGDT, 1)
#define	KESEL	SELECTOR(KESEG, SELGDT, 1)
#define	UESEL	SELECTOR(UESEG, SELGDT, 3)
#define	UDSEL	SELECTOR(UDSEG, SELGDT, 3)
#define	TSSSEL	SELECTOR(TSSSEG, SELGDT, 1)
#define	APMCSEL 	SELECTOR(APMCSEG, SELGDT, 1)
#define	APMCSEL16	SELECTOR(APMCSEG16, SELGDT, 1)
#define	APMDSEL		SELECTOR(APMDSEG, SELGDT, 1)
/* #define	APM40SEL	SELECTOR(APM40SEG, SELGDT, 1) */
